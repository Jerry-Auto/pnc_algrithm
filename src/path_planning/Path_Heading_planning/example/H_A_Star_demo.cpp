...
int main()
{
    ...
    world_map.addObstacle({50, 50, 10, 10, 0, "red"});
    world_map.addObstacle({50, 20, 10, 10, 0, "red"});
    world_map.addObstacle({12, 75, 20, 10, 0, "red"});
    world_map.addObstacle({80, 70, 2, 10, 0, "red"});
    ...
    world_map.addObstacle({6, 83, 6, 2, M_PI/6, "red"});
    world_map.addObstacle({6, 90, 6, 2, M_PI/6, "red"});
