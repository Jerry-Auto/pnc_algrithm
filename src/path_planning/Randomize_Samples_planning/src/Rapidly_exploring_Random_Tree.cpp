...
RRT::RRT(double robotRadius, double expandDis,
         double goalSampleRate, int maxIter) : robot_radius(robotRadius), expand_dis(expandDis),
                                               goal_sample_rate(goalSampleRate), max_iter(maxIter) {}
void RRT::init_solver(WorldMap* map)
{
 ...
 * @return 轨迹数据
 */
pair<vector<double>, vector<double>> RRT::planning(bool plot) {
